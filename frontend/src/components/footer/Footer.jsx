...
const socialLinks = [
  {
    ...
    icon:<AiFillYoutube className='b group-hover:text-white w-4 h-5'/>
  },
  {
    path:"https://github.com/codingwithmuhib",
    icon:<AiFillGithub className='b group-hover:text-white w-4 h-5'/>
  },
  {
    path:"https://www.instagram.com/muhib160.official",
    icon:<AiOutlineInstagram className='b group-hover:text-white w-4 h-5'/>
  },
  {
    path:"http://www.linkedin.com/in/codingwithmuhib/",
    icon:<RiLinkedinFill className='b group-hover:text-white w-4 h-5'/>
  }
];
