          ...
          <div className='md:col-span-2'>
            <div className='flex items-center gap-5'>
              ...
              <div>
                ...
                <h3 className='b text-headingColor text-[22px] leading-9 mt-3 font-bold'>Dr. Esiah Zulu</h3>
            ...
            <div className='mt-[50px] border-b border-solid border-[#0066ff34]'>
              <button
                ...
                className={`${Tab==='about' && 'b border-b border-primaryColor'} py-2 px-5 mr-5 text-[16px] leading-7 text-headingColor font-semibold`}
              >
                About
              </button>
              <button
                onClick={()=>setTab('feedback')}
                className={`${Tab==='feedback' && 'b border-b border-primaryColor'} py-2 px-5 mr-5 text-[16px] leading-7 text-headingColor font-semibold`}
              >
                Feedback
              </button>
            </div>
